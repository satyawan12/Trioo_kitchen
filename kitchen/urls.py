...
from .views import  gallery_page,german_kitchen,italian_kitchen,commercial_kitchen, island_kitchen,get_categories,Parallel_kitchen, get_projects, submit_inquiry,contact_view,about_page,kitchen_page,product_page,walkin_wardrobe,hinged_wardrobe,sliding_wardrobe,kitchen_U_page,g_shaped,inline_kitchen
